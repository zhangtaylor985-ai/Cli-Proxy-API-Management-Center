...
const extractSectionValue = (config: Config | null, section?: RawConfigSection) => {
  ...
  switch (section) {
    ...
    case 'disable-prompt-token-limit':
      return config.disablePromptTokenLimit;
    ...
    case 'session-trajectory-enabled':
      return config.sessionTrajectoryEnabled;
    ...
    set((state) => {
      ...
      switch (section) {
        ...
        case 'disable-claude-opus-1m':
          ...
          break;
        case 'disable-prompt-token-limit':
          nextConfig.disablePromptTokenLimit = value as Config['disablePromptTokenLimit'];
          break;
        case 'claude-code-only-enabled':
        ...
        case 'request-log':
          ...
          break;
        case 'session-trajectory-enabled':
          nextConfig.sessionTrajectoryEnabled = value as Config['sessionTrajectoryEnabled'];
          break;
        case 'logging-to-file':
